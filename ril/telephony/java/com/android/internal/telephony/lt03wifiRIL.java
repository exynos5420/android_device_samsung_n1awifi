 ...
 * {@hide}
 */
public class lt03wifiRIL extends RIL implements CommandsInterface {

    private boolean newril = needsOldRilFeature("newril"); //4.4.4 verson of Samsung RIL

    public lt03wifiRIL(Context context, int preferredNetworkType,
            int cdmaSubscription, Integer instanceId) {
        super(context, preferredNetworkType, cdmaSubscription, instanceId);
    }

    public lt03wifiRIL(Context context, int networkMode,
